...
import { Smartphone, ArrowRight, Star, Shield, Zap, Users } from "lucide-react";
...
const IndexPage = () => {
  ...
  const features = [
    ...
    { icon: <Zap className="h-6 w-6" />, title: "Lightning Fast", description: "Deliver messages in milliseconds" },
    { icon: <Shield className="h-6 w-6" />, title: "Bank-grade Security", description: "End-to-end encrypted communications" },
    { icon: <Users className="h-6 w-6" />, title: "Smart Contacts", description: "AI-powered contact management" },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "This platform transformed our customer support. Response times dropped by 80% and satisfaction scores skyrocketed.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "The automation features saved us 20+ hours per week. Now we focus on growing our business instead of managing messages.",
      rating: 5,
    },
    {
      name: "Alex Rodriguez",
      ...
      content:
        "Our team collaboration improved dramatically. The shared inbox and assignment features are game-changers.",
      rating: 5,
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-purple-900 text-white">
      ...
      <header className="relative z-10 px-6 py-8">
        <div className="container mx-auto flex items-center justify-between">
          ...
          >
            ...
            <a href="#testimonials" className="text-blue-100 hover:text-white transition-colors font-medium">
              Testimonials
            </a>
          </motion.nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
                <span className="bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent">Revolutionize</span>
                <br />
                Your Customer
                <br />
                <span className="bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">Conversations</span>
              </h1>

              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                The next-generation messaging platform that combines AI-powered automation with human touch. Connect with your
        ...
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">Powerful Features</span>
            </h2>
      ...
      <section id="pricing" className="relative z-10 py-20 px-6">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">Cost-effective messaging solutions for your business</p>
          </motion.div>
              ...
              <tbody>
                ...
                <tr className="border-b border-slate-700 hover:bg-slate-800/50">
                  <td className="p-4 text-slate-200">
                    ...
                    <div className="text-sm text-slate-400">
                      Business messaging phone number with a 3-digit prefix (Ex: 887) for high-throughput SMS and voice calls.
                    </div>
                  </td>
                  <td className="p-4 text-slate-200">$0.0088</td>
                  <td className="p-4 text-slate-200">$0.0088</td>
                ...
                <tr className="hover:bg-slate-800/50">
                  <td className="p-4 text-slate-200">
                    ...
                    <div className="text-sm text-slate-400">
                      A short number (5-6 digits) designed for high-throughput two-way SMS messaging.
                    </div>
                  </td>
                  <td className="p-4 text-slate-200">$0.0088</td>
                  <td className="p-4 text-slate-200">$0.0088</td>
              ...
              <tbody>
                <tr className="hover:bg-slate-800/50">
                  <td className="p-4 text-slate-200">
                    ...
                    <div className="text-sm text-slate-400">
                      Rich Communication Services (RCS) enables you to send branded, interactive text messages.
                    </div>
                  </td>
                  <td className="p-4 text-slate-200">$0.0088</td>
                  <td className="p-4 text-slate-200">$0.0088</td>
      ...
      <section id="testimonials" className="relative z-10 py-20 px-6">
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent">Loved by Teams</span>
            </h2>
          </motion.div>
      ...
      <footer className="relative z-10 py-12 border-t border-slate-800">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">© 2024 TK Messaging. All rights reserved.</p>
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="#" className="text-slate-400 hover:text-blue-300 transition-colors text-sm">
                Privacy
              </a>
              <a href="#" className="text-slate-400 hover:text-blue-300 transition-colors text-sm">
                Terms
