    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="I see the issue. The problem is with how we're handling the theme state synchronization between the theme provider and the settings component. Let me fix this:

<dyad-write path="src/components/user/UserSettings.tsx" description="Fix theme dropdown synchronization">
import React, { useState, useEffect } from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
