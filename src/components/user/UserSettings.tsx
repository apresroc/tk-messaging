...
const UserSettings = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Theme Settings */}
      <Card className="bg-white/10 backdrop-blur-sm border-white<dyad-write path="src/components/user/UserSettings.tsx" description="Update toggle buttons to use square red/green design with styling from screenshot">
import React, { useState, useEffect } from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
